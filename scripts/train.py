...
def _ensure_writable_warp_cache() -> None:
  """Fall back to /tmp when Warp's default user cache is not writable."""
...
def launch_training(task_id: str, args: TrainConfig | None = None):
  ...
  if num_gpus <= 1:
    ...
    torchrunx.Launcher(
      ...
      copy_env_vars=torchrunx.DEFAULT_ENV_VARS_FOR_COPY + ("MUJOCO*", "WARP_CACHE_PATH"),
